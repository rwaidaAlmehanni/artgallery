function datepicker(id, target, modal) {
    ...
    if ($('body').hasClass('en')) {
        ...
        this.dayNames = ['Montag', 'Dienstag', 'Mittwoch', 'Donnerstag', 'Freitag', 'Samstag','Sonntag'];
    }
...
datepicker.prototype.handleGridKeyDown = function(e) {
    ...
    switch(e.keyCode) {
        ...
        case this.keys.esc: {
            ...
            // dismiss the dialog box  - for inline version not necessary
            //this.hideDlg();

            // On esc focus next element
